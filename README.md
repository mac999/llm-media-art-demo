...
<img src="https://miro.medium.com/v2/resize:fit:720/format:webp/1*3kNBB0E4xDwKiC1SQcYbhA.png"><br>Prompt: Create sphere and cube around the sphere</br></img></br>
<img src="https://github.com/mac999/llm-media-art-demo/blob/main/openg_anime.gif"><br>Prompt: Create cubes grid with color (temperature) and height (energy) after reading input.csv including bulidings dataset with temperature, energy using pandas</br></img>
## Overview
